...
\faHome \quad 4 Garibaldi Street \\ \hspace*{.6cm} NGuelph \\ \hspace*{.6cm} ON, Canada
...
$if(tobepublished)$
\ifthenelse{\equal{$lang$}{fr}}{
  \section*{\textbf{Articles soumis ou à soumettre très prochainement}}}{
  \section*{\textbf{In Preparation / Submitted / Accepted articles}}}
\noindent
