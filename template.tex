...
$for(code)$
  ...
  \ifthenelse{\equal{$lang$}{fr}}{$code.description_fr$}{$code.description_eng$}
  ...
  $if(code.zenodo)$;~ Zenodo: \href{https://zenodo.org/record/$code.zenodo$}{10.5281/zenodo.$code.zenodo$}$endif$ \\[.14cm]
$endfor$
$endif$
