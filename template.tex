...
\item{
  ...
  $if(code.github)$\\ \faGithub \quad \href{https://github.com/$code.github$}{$code.github$}$endif$
  $if(code.zenodo)$\\ Zenodo \quad \href{https://zenodo.org/record/$code.zenodo$}{$code.zenodo$}$endif$
}
$endfor$
$endif$
\end{enumerate}
